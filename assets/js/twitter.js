    ...
    callback: function (a) {
      ...
      if (u)
        ...
        for (c = m(c, "tweet"); e < c.length;) a.push(m(c[e], "e-entry-title")[0]),
          n.push(c[e].getAttribute("data-tweet-id")), f.push(m(c[e], "p-author")[1]), g.push(m(c[e], "dt-updated")[0]), void 0 !== m(c[e], "inline-media")[0] ? h.push(m(c[e], "inline-media")[0]) : h.push(void 0), 0 < m(c[e], "retweet-credit").length ? b.push(!0) : b.push(!1), e++;
      ...
      for (b = 0; b < e;) {
        ...
        y ? (d += '<p class="tweet__content">' + '<span class="tweet__user">' + w(f[b].innerHTML) + ':</span>' + w(a[b].innerHTML) + "</p>", q) : a[b].innerText ? (r && (d += '<p class="tweet__user">' + f[b].innerText + "</p>"), d +=
          '<p class="tweet__content">' + a[b].innerText + "</p>", q && (d += '<p class="tweet__timePosted">' + g[b].innerText + "</p>")) : (r && (d += '<p class="tweet__user">' + f[b].textContent + "</p>"), d += '<p class="tweet">' + a[b].textContent + "</p>", q && (d += '<p class="tweet__timePosted">' + g[b].textContent + "</p>"));
        A && (d += '<ul class="tweet__footer">' + '<li><span class="tweet__timePosted">' + g[b].innerHTML + "</span></li>" + '<li><a href="https://twitter.com/intent/tweet?in_reply_to=' + n[b] + '">Reply</a></li><li><a href="https://twitter.com/intent/retweet?tweet_id=' + n[b] + '">Retweet</a></li><li><a href="https://twitter.com/intent/favorite?tweet_id=' +
